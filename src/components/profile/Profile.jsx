...
import { GetProfileDetails, UpdateProfileRequest } from '../../APIs/APIs';
import { ErrorToast, getBased64, IsEmail, IsEmpty, IsMobile } from '../../helpers/FormHelper';
...
const Profile = () => {
    ...
    const PreviewImage = () => {
        ...
        getBased64(ImgFile).then((base64Img) => {
